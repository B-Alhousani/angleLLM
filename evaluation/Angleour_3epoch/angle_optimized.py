...
if __name__ == "__main__":
    ...
    p.add_argument("--model_path", default="/mnt/dgx_lab/models/AndgeLM_Qwen3B_Discriptive_final")
    p.add_argument("--eval_jsonl", default="/mnt/dgx_lab/datasets/IbimsOurs/54281_dataset_metadata.jsonl")
    p.add_argument("--output_csv", default="discriptive_evaluation_results.csv")
