...
from utils.angle_dataset import dataset_eval
...
def main(args):
    ...
    # Changed normalized_focal_length -> fixed_scale_factor=1.0
    dataset = dataset_eval(json_path, img_folder, fixed_scale_factor=args.scale_factor)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_base_dir", type=str, default="/mnt/dgx_lab/evaluation/Angle_diverse_focals/")
